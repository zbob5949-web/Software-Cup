...
def login(form: LoginForm, request: Request, db=Depends(get_db)):
    return login_user(db, form.phone, form.password, form.code, request.client.host if request.client else None)
