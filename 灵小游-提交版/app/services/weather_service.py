...
def get_weather_data() -> dict:
    ...
    try:
        ...
        weather_resp = _weather_session.get(weather_url, params=params, timeout=(0.5, 1.5))
        weather_data = weather_resp.json()
        index_resp = _weather_session.get(index_url, params={**params, "type": 0}, timeout=(0.5, 1.5))
